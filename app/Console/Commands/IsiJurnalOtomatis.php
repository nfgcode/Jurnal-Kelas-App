...
class IsiJurnalOtomatis extends Command
{
    ...
    protected $description = 'Isi otomatis jurnal pertemuan lampau yang kosong (guru tidak hadir · tanpa tugas), per gelombang. Presensi siswa tidak ikut diisi — itu ditandai guru pengajarnya.';
